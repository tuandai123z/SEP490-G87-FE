    ...
    return (
        <div ref={ref} className="w-full p-5 mx-auto border border-gray-300 rounded-lg shadow-lg">
            ...
            <table className="w-[98%] mt-5 border border-gray-300 text-xs mx-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-center border border-gray-300">{formatVND(Math.round(totalCost))}</td>
                    </tr>
                    <tr>
                        <td colSpan="6" className="px-6 py-2 font-bold text-right border border-gray-300">Tổng tiền thanh toán:</td>
                        <td className="font-bold text-center border border-gray-300">{formatVND(Math.round(totalCost))}</td>
                    </tr>
                    <tr>
            ...
            <div className="flex flex-col mt-3 mb-12">
                <p className="flex gap-3 ml-4">Số tiền bằng chữ: <span className='font-semibold'>{numberToWords(Math.round(totalCost))}</span></p>
